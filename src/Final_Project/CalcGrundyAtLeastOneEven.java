...
public class CalcGrundyAtLeastOneEven {
	...
	public static void main(String[] args) {
		...
		//print the new grundy values
		System.out.println();
		System.out.print("Ngrundy: ");
		for (int x = 1; x < 10; x++) {
			System.out.print(Even_sprague_grundy(x) + " ");
		}
		for (int x = 10; x < 51; x++) {
			System.out.print(Even_sprague_grundy(x) + "  ");
		}
		//print the regular grundy values
		System.out.println();
		System.out.print("Ogrundy: ");
		for (int i = 0; i < 100; i++) {
			grundy[i] = -1;
		} 
		for (int x = 1; x < 10; x++) {
			System.out.print(sprague_grundy(x) + " ");
		}
		for (int x = 10; x < 51; x++) {
			System.out.print(sprague_grundy(x) + "  ");
		}
